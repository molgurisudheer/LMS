...
class LeavesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create leafe" do
    assert_difference('Leave.count') do
      post leaves_url, params: { leafe: { from_date: @leafe.from_date, reason: @leafe.reason, reporting_head_id: @leafe.reporting_head_id, status: @leafe.status, to_date: @leafe.to_date, user_id: @leafe.user_id } }
    end
  ...
  test "should update leafe" do
    patch leafe_url(@leafe), params: { leafe: { from_date: @leafe.from_date, reason: @leafe.reason, reporting_head_id: @leafe.reporting_head_id, status: @leafe.status, to_date: @leafe.to_date, user_id: @leafe.user_id } }
